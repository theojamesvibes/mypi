...
These all use `authed_page` (cached storage_state) rather than
...
def test_dashboard_shell_renders(authed_page: Page, base_url: str):
    page = authed_page
    expect(page).to_have_title("Dashboard — Pi-hole Dashboard")
